function make_knob(type, node,props){
  ...
  knob.prototype.onPropertyChanged = function(name, value) {
	...
	knob.prototype.onExecute = function(){}
	knob.prototype.onAdded = onNodeAdded;
	knob.prototype.onRemoved = onNodeRemoved;
  knob.prototype.onConnectionsChange = onConnectionsChange;
  knob.prototype.sendPropertyConfig = sendPropertyConfig;
